 ...
 * as an abstraction of a display method, similar in spirit to a LayoutManager.
 * Layers may be specialized for a certain screen element that needs to be drawn
 * and resized (and may change onTick as well); may be used as in an ActionLayer
 * in which only the onTick method is used; or may be used more generally, as in
 * some of the more common subclasses used in this package.
 *
